    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen gap-16 font-[family-name:var(--font-geist-sans)]">
      ...
      <main style={{ maxWidth: "98vw" }} className="overflow-hidden pt-20 text-center w-[98vw] justify-items-center">
        ...
        <div className="flex flex-col container text-black text-2xl w-full text-center justify-items-center border-black border md:grid md:grid-cols-3">
          ...
          <h2 className="py-20 text-6xl">Laser hybrydowy (frakcyjny + Er:YAG)</h2>
          <ul>
            <li>Połączenie technologii lasera frakcyjnego i erbowo-yagowego (Er:YAG)</li>
            <li>Działa na różnych głębokościach skóry, łącząc efekt ablacyjny i termiczny</li>
          </ul>
          <p className="py-4 text-4xl text-left">Zalety:</p>
          <ul className="list-disc pr-8 pl-8 text-left pb-10">
            <li>Precyzyjna kontrola złuszczania naskórka</li>
            <li>Głębokie stymulowanie produkcji kolagenu</li>
            <li>Krótszy okres rekonwalescencji w porównaniu do klasycznego lasera CO2</li>
          </ul>
          <p className="py-4 text-4xl text-left">Zabiegi:</p>
          <ul className="list-disc pr-8 pl-8 text-left pb-10">
            <li>Odmładzanie skóry</li>
            <li>Poprawa napięcia i elastyczności</li>
            <li>Redukcja blizn i przebarwień</li>
            <li>Wygładzanie zmarszczek</li>
          </ul>
          </div>
          <div className="justify-items-right">
            <Image src="/pics/p16.jpeg" alt="" width={1000} height={1000}/>
          </div>
        </div>
      </main>
      <Footer />
