...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen gap-16 font-[family-name:var(--font-geist-sans)]">
      ...
      <main style={{ width: "98vw" }} className="overflow-hidden pt-20 text-center">
        ...
        <div className="w-[98vw] flex flex-col md:grid md:grid-cols-5 md:gap-8 items-center text-black w-full bg-white">
          <div className="text-center md:w-full col-span-3 justify-items-center">
            ...
            <div className="flex flex-col justify-center text-xl w-full md:grid md:grid-cols-2 md:text-center">
              <div className="flex flex-col sm:w-full"><p>ul. Wileńska 39, Manhattan, box 113</p><p>76-200 Słupsk</p></div>
              ...
              <br />
              <div className="flex place-content-around col-span-2 w-full"><Facebook/><Instagram/><WhatsApp/></div>
            </div>
            <br />
            <iframe className="justify-self-center w-full md:ml-10 sm:m-0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2318.3073038303396!2d17.0172382770225!3d54.46498239043967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46fe10a824f679b9%3A0xef089efff4316619!2sC.H.%20Manhatan!5e0!3m2!1spl!2spl!4v1742386425730!5m2!1spl!2spl" height="450" loading="lazy"></iframe>
            </div>
