      ...
      {editing && (
        <span style={{ position: "absolute", top: "calc(100% + 5px)", left: 0, zIndex: 300, display: "flex", alignItems: "center", gap: "8px", whiteSpace: "nowrap" }}>
          <button
            ...
            style={{
              padding: "4px 12px",
              fontFamily: "var(--font-jost, sans-serif)", fontSize: "10px",
...
function Hint() {
  return (
    <p style={{
      fontFamily: "var(--font-jost)", fontSize: "11px", color: "rgba(154,107,32,.5)",
...
export default function VisualEditorPage() {
  ...
  const previews: Record<string, React.ReactNode> = {
    ...
    bar: (
      <div>
        <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"16px" }}>PASEK OGŁOSZEŃ (góra strony)</p>
        <div style={{ background:"#0a0a0a", borderBottom:"1px solid rgba(201,149,106,.08)", padding:"10px 24px", display:"flex", alignItems:"center", justifyContent:"center", borderRadius:"2px" }}>
          <p style={{ fontFamily:"var(--font-jost)", fontSize:"12px", fontWeight:400, letterSpacing:".04em", color:"rgba(248,244,238,.9)", margin:0 }}>
        ...
        <p style={{ fontFamily:"var(--font-jost)", fontSize:"11px", color:"rgba(154,107,32,.4)", marginTop:"12px" }}>
    ...
    catalog: (
      <div>
        <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"16px" }}>HERO — KATALOG PRODUKTOWY</p>
        <div style={{
          ...
          <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".5em", textTransform:"uppercase", marginBottom:"24px", position:"relative" }}>
    ...
    login: (
      <div>
        <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"16px" }}>LOGOWANIE — LEWA KOLUMNA</p>
        <div style={{
          background:"linear-gradient(135deg, rgba(10,8,6,1) 0%, rgba(20,15,10,1) 100%)",
          ...
          <div style={{ marginBottom:"40px" }}>
            ...
            <p style={{ fontFamily:"var(--font-jost)", fontSize:"10px", letterSpacing:".3em", textTransform:"uppercase", color:"var(--text-muted)" }}>
              {T("login_platform_label", "Platforma B2B", { color:"var(--text-muted)" })}
            </p>
          </div>
          <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".5em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"20px" }}>
    ...
    payment: (
      <div>
        <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"16px" }}>DANE PŁATNOŚCI (koszyk / potwierdzenie)</p>
        <div style={{ display:"flex", flexDirection:"column", gap:"2px" }}>
          ...
          <div style={{ background:"rgba(10,8,6,1)", border:"1px solid rgba(154,107,32,.18)", padding:"20px 24px", "--pearl": "#F8F4EE", "--text-muted": "rgba(248,244,238,.55)", "--gold": "#C9956A" } as React.CSSProperties}>
            <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"8px", letterSpacing:".3em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"10px" }}>Przelew bankowy</p>
          ...
          {/* BLIK */}
          <div style={{ background:"rgba(10,8,6,1)", border:"1px solid rgba(154,107,32,.18)", padding:"20px 24px", "--pearl": "#F8F4EE", "--text-muted": "rgba(248,244,238,.55)", "--gold": "#C9956A" } as React.CSSProperties}>
            <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"8px", letterSpacing:".3em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"10px" }}>BLIK na telefon</p>
            <div style={{ fontFamily:"var(--font-jost)", fontSize:"13px", fontWeight:400, color:"var(--text-muted)", lineHeight:1.7 }}>
              Numer BLIK:{" "}
    ...
    marquee: (
      <div>
        <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"16px" }}>PASEK PRZEWIJANIA (marquee)</p>
        <div style={{ background:"rgba(154,107,32,.06)", padding:"14px 0", overflow:"hidden", whiteSpace:"nowrap", borderRadius:"2px" }}>
          {[0,1,2].map(i => (
            <span key={i} style={{ fontFamily:"var(--font-cinzel)", fontSize:"10px", letterSpacing:".4em", textTransform:"uppercase", color:"var(--gold)", opacity:.5, marginRight:"40px" }}>
    ...
    <div style={{ minHeight:"100vh", background:"var(--obsidian)" }}>
      <div style={{ maxWidth:"1100px", margin:"0 auto", padding:"36px 20px 80px" }}>
        ...
        <div style={{ marginBottom:"32px" }}>
          <p style={{ fontFamily:"var(--font-cinzel)", fontSize:"9px", letterSpacing:".35em", textTransform:"uppercase", color:"var(--gold)", marginBottom:"10px" }}>Panel administracyjny</p>
          <h1 style={{ fontFamily:"var(--font-cormorant)", fontSize:"clamp(28px,5vw,40px)", fontWeight:400, color:"var(--pearl)", lineHeight:1 }}>
            Edytor treści
          </h1>
          <p style={{ fontFamily:"var(--font-jost)", fontSize:"12px", color:"var(--text-muted)", marginTop:"8px" }}>
          ...
          {loadError && (
            <div style={{
              ...
              fontFamily:"var(--font-jost)", fontSize:"12px", color:"#c0392b",
              borderRadius:"2px",
            }}>
