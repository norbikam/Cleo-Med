...
export default function MembercardInfo() {
  return (
    <section className="relative min-h-auto flex items-center justify-center px-4 py-12">
      {/* Background layer with fixed attachment for parallax effect */}
      <div
        className="absolute inset-0 z-[-1] bg-cover bg-center bg-fixed bg-no-repeat md:bg-scroll"
        style={{
          backgroundImage:
